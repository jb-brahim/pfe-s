...
cell4_source = [
    ...
    "        'client': r'(?:Client|Factur.\\s*.)[:\\s]*([A-Za-z\\u00c0-\\u00ff\\s]{3,})',\n",
    "        'companyName': r'([A-Za-z\\u00c0-\\u00ff0-9\\s]{3,}(?:SARL|SAS|SA|EURL))',\n",
    "    }\n",
...
notebook = {
    ...
    "cells": [
        {"cell_type": "markdown", "metadata": {}, "source": ["# Invoice Dataset Processor\n", "Run all cells. Results saved to `extracted_invoices.csv` in Google Drive."]},
        {"cell_type": "code", "execution_count": None, "metadata": {"id": "install"}, "outputs": [], "source": cell1_source},
        {"cell_type": "code", "execution_count": None, "metadata": {"id": "drive"}, "outputs": [], "source": cell2_source},
        {"cell_type": "code", "execution_count": None, "metadata": {"id": "setup"}, "outputs": [], "source": cell3_source},
        {"cell_type": "code", "execution_count": None, "metadata": {"id": "extractor"}, "outputs": [], "source": cell4_source},
        {"cell_type": "code", "execution_count": None, "metadata": {"id": "run"}, "outputs": [], "source": cell5_source},
    ]
}

with open("Untitled35.ipynb", "w", encoding="utf-8") as f:
